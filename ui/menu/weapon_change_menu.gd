...
func change_proposed_weapon(new_weapon: Weapon):
    weapon = new_weapon
    %NewWeapon.change_weapon(weapon, "")
    %NewWeapon.change_compare_to(WeaponService.equipped_weapon)
    %EquippedWeapon.change_compare_to(weapon)
